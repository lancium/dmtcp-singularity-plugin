// Copyright (c) 2018-2019, Sylabs Inc. All rights reserved. -- CHECK
...
var Plugin = pluginapi.Plugin{
	Manifest: pluginapi.Manifest{
		Name:        "lancium.com/dmtcp-singularity-plugin",
		Author:      "Lancium Team",
		Version:     "0.0.1",
		Description: "This is a wrapper for DMTCP within a Singularity container",
	},
